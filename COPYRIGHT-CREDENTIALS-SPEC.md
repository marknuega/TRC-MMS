...
| © 2026 Muhammad Amir. All rights reserved.    | Electrical License#: CLN-NQ-\*\*\*6092 · Electronics License#: CLN-NQ-\*\*\*6595 |

(Right-side licenses are joined by a middot `·`.)

## Rules

1. **Masked license numbers only** — always `CLN-NQ-***6092` and `CLN-NQ-***6595`. Never the full digits, anywhere in code or output.
...
<footer>
  <span style="display:flex;justify-content:space-between;gap:12px;flex-wrap:wrap;width:100%">
    ...
    <span style="text-align:right">Certified Electronics and Electrical Technician<br>Electrical License#: CLN-NQ-***6092 · Electronics License#: CLN-NQ-***6595</span>
  </span>
</footer>
```
