...
const slides = [
  ...
  },
  {
    ...
    intro: 'The field team sends the work payload first, then proves the agency context before anything is committed.',
  },
  {
    id: 'parser',
  ...
  },
  {
    ...
    intro: 'A verified entry fans out into the records teams need to operate, reconcile, and learn from the work.',
  },
  {
    id: 'governance',
    ...
    <div className="deck-overview">
      <div className="deck-overview-copy">
        ...
        <div className="deck-overview-bottom">
          ...
          <div className="deck-live-cta">
            ...
            <a href="https://trc-mms.up.railway.app/" target="_blank" rel="noreferrer">
      ...
      <div className="deck-architecture">
        ...
        <div className="deck-model-note">
          ...
          <br />
          Unique database identity. Compact field token remains <strong>H</strong>.
    ...
    <div className="deck-protocol">
      <div className="deck-step step-one">
        ...
        <div>
          ...
          <p>Encodes device, component variant, action, quantity, company, Tel+ISSI, and technician ID.</p>
      ...
      <div className="deck-step step-two">
        ...
        <div>
          ...
          <p>Locks the agency partition, validates the session, and triggers batch compilation.</p>
          <code>PSD</code>
        </div>
      </div>
    ...
    <div className="deck-governance">
      ...
      <div className="deck-governance-list">
        ...
        <div>
          ...
          <p>Field teams see their branch; managers see their assigned operating zone.</p>
        </div>
        <div>
          <b>03</b>
          <h3>Audit trail integrity</h3>
          <p>Technician, masked Tel+ISSI, timestamp, and authorization are retained.</p>
        </div>
      </div>
    </div>
  )
...
export default function Presentation() {
  ...
  const move = (delta) => setCurrent((value) => Math.min(slides.length - 1, Math.max(0, value + delta)))
  ...
  return (
    <section className={`deck deck-${slide.id}`} aria-label="TRC-MMS presentation">
      ...
      <div className="deck-controls">
        ...
        <div className="deck-arrows">
          <button type="button" onClick={() => move(-1)} disabled={current === 0} aria-label="Previous slide">
            ←
          </button>
          <button
            type="button"
